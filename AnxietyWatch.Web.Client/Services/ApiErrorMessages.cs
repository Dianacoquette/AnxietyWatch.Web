...
public static class ApiErrorMessages
{
    public static string For(ApiException exception, string fallback = "No pudimos completar la operación.") =>
        ...
        {
            400 => exception.Problem.Title ?? "Revisa los datos ingresados e inténtalo nuevamente.",
            401 => "Tu sesión ha expirado. Inicia sesión nuevamente.",
            403 => "Tu plan actual no permite realizar esta operación.",
            404 => exception.Problem.Title ?? "No encontramos el recurso solicitado.",
            409 => exception.Problem.Title ?? "La operación entra en conflicto con el estado actual.",
            410 => exception.Problem.Title ?? "El recurso solicitado ya no está disponible.",
            ...
            _ => exception.Problem.Title ?? fallback
        };
}
